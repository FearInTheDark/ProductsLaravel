<x-layout>
    ...
    <section class="bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-8 h-8 mr-2" src="https://upload.wikimedia.org/wikipedia/commons/9/9a/Laravel.svg"
                     alt="logo" width="40">
                Laravel
            </a>
            <div
